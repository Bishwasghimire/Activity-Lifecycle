package com.example.twoactivitieslifecyclecodingchallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showitems(View view) {
        Intent intent = new Intent(this, com.example.twoactivitieslifecyclecodingchallenge.SecondActivity.class);
